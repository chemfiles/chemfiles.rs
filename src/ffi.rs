...
extern "C" {
    ...
    pub fn chrp_topology_append(topology: *mut CHRP_TOPOLOGY, atom: *mut CHRP_ATOM) -> CHRP_STATUS;
    pub fn chrp_topology_remove(topology: *mut CHRP_TOPOLOGY, i: libc::size_t) -> CHRP_STATUS;
    pub fn chrp_topology_isbond(topology: *mut CHRP_TOPOLOGY, i: libc::size_t, j: libc::size_t, result: *mut u8) -> CHRP_STATUS;
    pub fn chrp_topology_isangle(topology: *mut CHRP_TOPOLOGY, i: libc::size_t, j: libc::size_t, k: libc::size_t, result: *mut u8) -> CHRP_STATUS;
    pub fn chrp_topology_isdihedral(topology: *mut CHRP_TOPOLOGY, i: libc::size_t, j: libc::size_t, k: libc::size_t, m: libc::size_t, result: *mut u8) -> CHRP_STATUS;
    pub fn chrp_topology_bonds_count(topology: *mut CHRP_TOPOLOGY, nbonds: *mut libc::size_t) -> CHRP_STATUS;
    pub fn chrp_topology_angles_count(topology: *mut CHRP_TOPOLOGY, nangles: *mut libc::size_t) -> CHRP_STATUS;
    pub fn chrp_topology_dihedrals_count(topology: *mut CHRP_TOPOLOGY, ndihedrals: *mut libc::size_t) -> CHRP_STATUS;
    pub fn chrp_topology_bonds(topology: *mut CHRP_TOPOLOGY, data: *mut libc::c_void, nbonds: libc::size_t) -> CHRP_STATUS;
    pub fn chrp_topology_angles(topology: *mut CHRP_TOPOLOGY, data: *mut libc::c_void, nangles: libc::size_t) -> CHRP_STATUS;
    pub fn chrp_topology_dihedrals(topology: *mut CHRP_TOPOLOGY, data: *mut libc::c_void, ndihedrals: libc::size_t) -> CHRP_STATUS;
