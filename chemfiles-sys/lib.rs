...
extern "C" {
    ...
    pub fn chfl_frame_positions(frame: *const CHFL_FRAME, data: *mut libc::c_float, size: size_t) -> CHFL_STATUS;
    pub fn chfl_frame_set_positions(frame: *mut CHFL_FRAME, data: *const libc::c_float, size: size_t) -> CHFL_STATUS;
    pub fn chfl_frame_velocities(frame: *const CHFL_FRAME, data: *mut libc::c_float, size: size_t) -> CHFL_STATUS;
    pub fn chfl_frame_set_velocities(frame: *mut CHFL_FRAME, data: *const libc::c_float, size: size_t) -> CHFL_STATUS;
    ...
    pub fn chfl_topology_isbond(topology: *const CHFL_TOPOLOGY, i: size_t, j: size_t, result: *mut u8) -> CHFL_STATUS;
    pub fn chfl_topology_isangle(topology: *const CHFL_TOPOLOGY, i: size_t, j: size_t, k: size_t, result: *mut u8) -> CHFL_STATUS;
    pub fn chfl_topology_isdihedral(topology: *const CHFL_TOPOLOGY, i: size_t, j: size_t, k: size_t, m: size_t, result: *mut u8) -> CHFL_STATUS;
    ...
    pub fn chfl_topology_bonds(topology: *const CHFL_TOPOLOGY, data: *mut size_t, nbonds: size_t) -> CHFL_STATUS;
    pub fn chfl_topology_angles(topology: *const CHFL_TOPOLOGY, data: *mut size_t, nangles: size_t) -> CHFL_STATUS;
    pub fn chfl_topology_dihedrals(topology: *const CHFL_TOPOLOGY, data: *mut size_t, ndihedrals: size_t) -> CHFL_STATUS;
    ...
    pub fn chfl_atom_name(atom: *const CHFL_ATOM, name: *mut libc::c_char, buffsize: size_t) -> CHFL_STATUS;
    pub fn chfl_atom_set_name(atom: *mut CHFL_ATOM, name: *const libc::c_char) -> CHFL_STATUS;
    pub fn chfl_atom_full_name(atom: *const CHFL_ATOM, name: *mut libc::c_char, buffsize: size_t) -> CHFL_STATUS;
