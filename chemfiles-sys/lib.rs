...
extern "C" {
    ...
    pub fn chfl_property_get_bool(property: *const CHFL_PROPERTY, data: *mut c_bool) -> chfl_status;
    pub fn chfl_property_get_double(property: *const CHFL_PROPERTY, data: *mut c_double) -> chfl_status;
    pub fn chfl_property_get_string(property: *const CHFL_PROPERTY, buffer: *mut c_char, buffsize: uint64_t) -> chfl_status;
    pub fn chfl_property_get_vector3d(property: *const CHFL_PROPERTY, data: *mut c_double) -> chfl_status;
    pub fn chfl_property_free(property: *mut CHFL_PROPERTY) -> chfl_status;
    ...
    pub fn chfl_residue_atoms(residue: *const CHFL_RESIDUE, atoms: *mut uint64_t, n: uint64_t) -> chfl_status;
    ...
    pub fn chfl_topology_atoms_count(topology: *const CHFL_TOPOLOGY, size: *mut uint64_t) -> chfl_status;
    pub fn chfl_topology_resize(topology: *mut CHFL_TOPOLOGY, n: uint64_t) -> chfl_status;
    ...
    pub fn chfl_topology_impropers_count(topology: *const CHFL_TOPOLOGY, nimpropers: *mut uint64_t) -> chfl_status;
    ...
    pub fn chfl_topology_impropers(topology: *const CHFL_TOPOLOGY, data: *mut [uint64_t; 4], nimpropers: uint64_t) -> chfl_status;
    ...
    pub fn chfl_frame_atoms_count(frame: *const CHFL_FRAME, n: *mut uint64_t) -> chfl_status;
    ...
    pub fn chfl_selection_matches(selection: *const CHFL_SELECTION, matches: *mut chfl_match, nmatches: uint64_t) -> chfl_status;
